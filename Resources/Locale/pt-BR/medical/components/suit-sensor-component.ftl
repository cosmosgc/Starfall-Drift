...
suit-sensor-mode-vitals = Sinais vitais
...
suit-sensor-description-cords = O estado de saúde e a posição são reportados à estação.

suit-sensor-mode-state =  Sensores de traje: { $mode }
...
suit-sensor-examine-vitals =  Seu rastreador vital parece estar ativado.

suit-sensor-examine-cords =  Seu rastreador e sinal de rastreamento vitais parecem estar ativados.
