...
panicbunker-command-disabled = O abrigo do pânico foi desativado.
...
panicbunker-command-disable-with-admins-disabled = O abrigo de pânico não irá desativar automaticamente com os administradores online.
...
panicbunker-command-enable-without-admins-disabled = O abrigo de pânico não vai ativar automaticamente sem administradores online.
...
panicbunker-command-count-deadminned-admins-disabled = O abrigo de pânico não contará administradores sem vigilância quando feitos para ativar e desativar automaticamente.
...
panicbunker-command-show-reason-disabled = O abrigo de pânico não mostrará mais uma razão para usuários que bloqueiam a conexão.
...
panicbunker-command-min-account-age-set = Defina a idade mínima para o abrigo de pânico. { $minutes }  minutos.
...
panicbunker-command-min-overall-minutes-set =  Ajuste o tempo de jogo mínimo para o abrigo de pânico para { $minutes }  minutos.
