...
chat-radio-message-wrap = [color={ $color }]{ $channel } [bold]{ $name }[/bold] { $verb }, [font={ $fontType }  Tamanho={ $fontSize }]“{ $message }”[/font][/color]

chat-radio-message-wrap-bold = [color={ $color }]{ $channel } [bold]{ $name }[/bold] { $verb }, [font={ $fontType }  Tamanho={ $fontSize }][bold]“{ $message }”[/bold][/font][/color]
