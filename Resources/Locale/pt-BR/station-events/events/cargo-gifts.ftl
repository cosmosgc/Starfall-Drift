cargo-gifts-event-announcement =  Parabéns! { $sender }  Decidiu enviar { $description } Para a estação. { $dest } Procure no próximo carregamento.

cargo-gift-default-description = Um pacote de presentes

cargo-gift-default-sender = NanoTrasen

cargo-gift-default-dest = Depto. de Carga.

cargo-gift-dest-bar = Bar

cargo-gift-dest-eng =  Departamento de Engenharia

cargo-gift-dest-supp = Dept. de Carga
...
cargo-gift-vending =  Máquinas de venda de recargas.

cargo-gift-cleaning =  Equipamento de limpeza

cargo-gift-medical-supply = Suprimentos médicos.

cargo-gift-space-protection =  Proteção de Perigo Espacial
